//Based largely on https://github.com/rcrowley/go-tigertonic/blob/master/tee.go
package logical
...
func (r *TeeResponseWriter) Header() http.Header {
	r.RawHeader = r.ResponseWriter.Header()
	return r.RawHeader
}
